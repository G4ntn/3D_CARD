  ...
  return (
    <div className="responsive-wrapper">
      <Canvas
        ...
        style={{ background: 'transparent' }} // <-- Ensure container background transparent
      ...
      >
        ...
        <Environment
          background={false}  // <-- Disable environment background so canvas BG is transparent
          blur={0.75}
        >
